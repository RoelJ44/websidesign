  ...
  return (
    ...
    >
      <div className="container max-w-4xl mx-auto relative">
        ...
        <P>
          Websidesign verwerkt je persoonsgegevens doordat je gebruik maakt van
        ...
        <P>
          ...
          <ul className="mt-2">
            ...
            <li className="mb-2">
              - Websidesign verwerkt ook persoonsgegevens als wij hier wettelijk
        ...
        <P>
          ...
          beveiliging en vertrouwelijkheid van jouw gegevens. Websidesign blijft
          verantwoordelijk voor deze verwerkingen. Daarnaast verstrekt
        ...
        <P>
          Websidesign gebruikt functionele, analytische en tracking cookies. Een
          ...
          smartphone. Websidesign gebruikt cookies met een puur technische
          functionaliteit. Deze zorgen ervoor dat de website naar behoren werkt
          en dat bijvoorbeeld jouw voorkeursinstellingen onthouden worden. Deze
        ...
        <P>
          ...
          over deze cookies en hebben we je toestemming gevraagd voor het
          plaatsen ervan. Je kunt je afmelden voor cookies door je
        ...
        <H5 addClass="text-blue">Gegevens inzien, aanpassen of verwijderen</H5>
        <P>
          ...
          verwerking van jouw persoonsgegevens door Websidesign en heb je het
        ...
        <P>
          ...
          te zijn dat het verzoek tot inzage door jou is gedaan, vragen wij jou
          een kopie van je identiteitsbewijs met het verzoek mee te sturen. Maak
        ...
        <P>
          Websidesign wil je er tevens op wijzen dat je de mogelijkheid hebt om
        ...
        <P>
          ...
          klantenservice of vie service@websidesign.nl
        </P>
      </div>
    </Layout>
  );
